...
Supported Models
-------------
Galaxy Tab S8 Ultra (Snapdragon): X806B, X806C, X806N and X800.

Download & Guide
-------------
                
1. Unlock your bootloader.
2. Downloads for Galaxy Tab S8 Ultra (Snapdragon): [gts8u](https://www.androidfilehost.com/?w=files&flid=334655)
3. Reboot to download mode
4. Uncheck auto reboot in Odin and flash TWRP in AP slot and [vbmeta_disabled.tar](https://github.com/afaneh92/android_device_samsung_gts8u/raw/github.io/docs/vbmeta_disabled.tar) in USERDATA slot.
...
[Device tree](https://github.com/afaneh92/android_device_samsung_gts8u)

Changelog
-------------
[GitHub History](https://github.com/afaneh92/android_device_samsung_gts8u/commits/android-12.1)
